...
const widgetStyle = {
  background: 'rgba(255, 202, 16, 0.08)',
  backdropFilter: 'blur(30px) saturate(180%)',
  WebkitBackdropFilter: 'blur(30px) saturate(180%)',
  border: '1.5px solid rgba(255, 202, 16, 0.3)',
  borderRadius: '24px',
  padding: '1.5rem',
  position: 'relative',
  minHeight: '320px',
  ...
  boxShadow: '0 8px 32px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255, 202, 16, 0.1) inset, 0 1px 0 rgba(255, 255, 255, 0.05) inset',
