    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255, 255, 255, 0.6)', marginBottom: '2rem', lineHeight: '1.6' }}>
            Upgrade to premium to get <strong style={{ color: '#8b5cf6' }}>unlimited AI game scripts</strong>, 
            plus access to all analyst picks, prop tools, and premium dashboards.
          </p>
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
            <a 
