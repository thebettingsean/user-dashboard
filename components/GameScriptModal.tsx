...
export default function GameScriptModal({ isOpen, gameId, sport, onClose }: GameScriptModalProps) {
  ...
  // Show upgrade prompt (no credits)
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1rem', color: 'rgba(255, 255, 255, 0.6)', marginBottom: '2rem', lineHeight: '1.6' }}>
            Choose how you'd like to access AI game scripts:
          </p>
          ...
          <div style={{ 
            ...
            onMouseLeave={(e) => {
              ...
              <div style={{ fontSize: '1.1rem', fontWeight: '600', color: '#8b5cf6', marginBottom: '0.75rem' }}>
                15 AI Scripts
              </div>
              <div style={{ fontSize: '0.85rem', color: 'rgba(255, 255, 255, 0.4)', lineHeight: '1.5' }}>
                • AI game scripts only<br />
                • No other access<br />
            ...
            onClick={() => window.open('https://www.thebettinginsider.com/pricing', '_blank')}
            onMouseEnter={(e) => {
            ...
            onMouseLeave={(e) => {
              ...
              <div style={{ fontSize: '1.1rem', fontWeight: '600', color: '#10b981', marginBottom: '0.75rem' }}>
                Unlimited Scripts
              </div>
              <div style={{ fontSize: '0.85rem', color: 'rgba(255, 255, 255, 0.7)', lineHeight: '1.5' }}>
                • Unlimited AI scripts<br />
                • All analyst picks<br />
                • All prop tools<br />
                • Premium dashboards
              </div>
            </div>
