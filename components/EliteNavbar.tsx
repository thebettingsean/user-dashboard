...
import styles from './EliteNavbar.module.css'
          ...
          <div className={styles.dropdown} ref={sportsRef}>
            ...
            {sportsOpen && (
              <div className={styles.dropdownMenu}>
                ...
                <Link href="/sports/ncaab" className={styles.dropdownItem}>NCAAB</Link>
                <Link href="/sports/cfb" className={styles.dropdownItem}>CFB</Link>
              </div>
            )}
          </div>
          ...
          <div className={styles.dropdown} ref={toolsRef}>
            ...
            {toolsOpen && (
              <div className={styles.dropdownMenu}>
                ...
                <Link href="/betting-guide" className={styles.dropdownItem}>Betting Guide</Link>
              </div>
            )}
          </div>
        </div>
      ...
      {mobileMenuOpen && (
        <>
          ...
          <div className={styles.mobileMenu}>
            ...
            <Link href="/sports/ncaab" className={styles.mobileNavLink} onClick={() => setMobileMenuOpen(false)}>NCAAB</Link>
            <Link href="/sports/cfb" className={styles.mobileNavLink} onClick={() => setMobileMenuOpen(false)}>CFB</Link>
            ...
            <Link href="/betting-guide" className={styles.mobileNavLink} onClick={() => setMobileMenuOpen(false)}>Betting Guide</Link>
          </div>
        </>
      )}
    </nav>
