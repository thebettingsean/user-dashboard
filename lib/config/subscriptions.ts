...
// =============================================================================
// BACKWARD COMPATIBILITY - Legacy SUBSCRIPTION_CONFIG
// This is used by the old useSubscription.js hook
// =============================================================================
export const SUBSCRIPTION_CONFIG = {
  ...
  allAccess() {
    return [
      ...this.insiderAllAccess.priceIds,
...
export function isSubscriptionActive(cancelAt: string | null | undefined): boolean {
