...
import styles from './test-engine.module.css'
...
export default function TestEnginePage() {
  ...
  const renderPropDetails = (game: any) => {
    ...
    const playerPos = game.player_position || selectedPlayer?.position || position
