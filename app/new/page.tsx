  ...
  const renderPublicView = () => {
    try {
      ...
      if (activeFilter === 'publicAbout') {
        return renderPlaceholder('We aggregate live betting splits, sharp money signals, and line movement to spotlight where the market is leaning. Use the filters above to view the top markets, Vegas-backed shifts, or big-money positions for each matchup.')
      }
